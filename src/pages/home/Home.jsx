...
export function Home() {
  return (
    <div className="grid lg:grid-rows-subgrid lg:grid-cols-subgrid lg:h-svh min-h-svh gap-4 md:gap-6 p-4 md:p-6 lg:py-30 lg:px-56 lg:col-span-10 lg:row-span-10">
      {/* Hero Section */}
      <header className="col-span-10 row-span-5 md:col-span-5 md:row-span-10 lg:col-span-5 lg:row-span-8 flex flex-col justify-between lg:justify-evenly p-4 md:p-8 lg:p-8 bg-pollar-night-nord0 border-2 border-solid border-pollar-night-nord3 rounded-lg shadow-small">
        <figure className="w-full h-fit rounded-lg col-start-2 flex justify-end">
          <img
            src={heroData.image}
            alt={heroData.title}
            className="w-28 md:w-48 lg:w-56 h-fit rounded-lg border-2 border-solid border-pollar-night-nord1"
          />
        </figure>
        ...
        <button className="flex items-center justify-center gap-1.5 md:gap-3 lg:gap-5 bg-aurora-nord12 w-fit px-2 py-1 md:px-4 md:py-2 lg:px-5 lg:py-3 rounded-md text-pollar-night-nord0 hover:bg-aurora-nord14 transition-colors">
          <i
      ...
      {/* Tagline section */}
      <div className="col-span-10 md:col-span-5 row-span-2 md:row-span-6 flex flex-col gap-3 md:justify-between bg-aurora-nord14 p-4 md:p-6 border-2 border-solid border-pollar-night-nord3 rounded-lg shadow-small lg:col-span-5 lg:row-span-4">
      ...
      {/* Niches section */}
      <div className="col-span-6 md:col-span-5 row-span-3 md:row-span-2 lg:col-span-5 lg:row-span-2 flex flex-col gap-4 md:justify-between bg-frost-nord8 p-4 md:p-6 border-2 border-solid border-pollar-night-nord3 rounded-lg shadow-small">
      ...
      {/* Experience section */}
      <div className="col-span-4 md:col-span-5 row-span-3 md:row-span-2 lg:col-span-5 lg:row-span-2 flex flex-col gap-8 md:justify-between bg-aurora-nord13 p-4 md:p-6 border-2 border-solid border-pollar-night-nord3 rounded-lg shadow-small">
